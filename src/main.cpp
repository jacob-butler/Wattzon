...
int main()
{
    ...
    while (1)
    {
        ...
        for (i = 0; i < num_of_frames; ++i)
        {
            ...
            float objectNear = 10; 
            for(int i = 0; i<8; ++i){
                float dist_to_center1 = rs2_depth_frame_get_distance(frame, width*i / 8, height*3 / 9, &e);
                float dist_to_center2 = rs2_depth_frame_get_distance(frame, width*i / 8, height*6 / 9, &e);
                float dist_to_center3 = rs2_depth_frame_get_distance(frame, width*i / 8, 360, &e);
                //printf("distance %.3f \n", dist_to_center);
